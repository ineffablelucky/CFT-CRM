...
from .views import ProjectList, Employee_Project_List, ProjectCreate, Edit_Project, ListModule, OppProjectList, Edit_Project_opp
...
urlpatterns = [
    ...
    path('update/opp/<int:pk>/', Edit_Project_opp.as_view(), name='project-opp-update'),
