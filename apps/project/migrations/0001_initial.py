    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_start_date_time', models.DateField(blank=True, default=datetime.datetime(2018, 6, 28, 12, 18, 54, 540825), null=True)),
                ('project_end_date_time', models.DateField(blank=True, default=None, null=True)),
            ...
            options={
                'permissions': (('view_it_project', 'Can view projects'),),
            },
        ),
    ]
